...
When("the OpenAI API Key value is set on the page", async () => {
    ...
    await input.setValue("sk-proj-meaningfullytesting-1234567890123456789012345678901234567890");
...
Then('the text of the {string} component is a masked version of the set value.', async (componentName: string) => {
    ...
    expect(value).toContain("*******");
    expect(value).not.toEqual("sk-proj-meaningfullytesting-1234567890123456789012345678901234567890");
});